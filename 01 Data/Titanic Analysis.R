...
# display a subset and summary of the datafram
...
ggplot() +
  ...
  scale_x_discrete() +
  scale_y_continuous() +
  layer(data=subset(df, !is.na(PCLASS)),
...
# Change SQL statement in creation of dataframe for plot #5
